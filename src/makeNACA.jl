...
Creates the coordinates for a NACA 4-series airfoil based
on c,p,and t.

"""

# include("Desktop/FLOW Lab/NACA XFOIL Exploration/naca.jl"); coordinates = naca(2,4,12); x = coordinates[:,1]; y = coordinates[:,2]; plot(x,y,seriestype = scatter,aspect_ratio = 1)
